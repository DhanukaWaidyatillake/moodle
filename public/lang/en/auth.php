...
$string['authinstructions'] = 'Custom content for the login page information panel. Leave blank to use the default welcome message. To hide the panel entirely, disable "Show login page information panel" in the setting above.';
