...
$string['auth_forgotpasswordrecaptcha_desc'] = 'Add a visual/audio confirmation form element to the forgot password page. This reduces the risk of unwarranted forgotten password attempts. For more details see <a href="https://www.google.com/recaptcha">Google reCAPTCHA</a>.';
...
$string['authinstructions'] = 'Custom content for the login page information panel. On desktop this appears in the left panel; on mobile it appears below the login form. Leave blank to use the default welcome message on desktop. To hide the panel entirely, disable "Show login page information panel" in the setting above.';
