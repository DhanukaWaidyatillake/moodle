    ...
    public function get_topic_data($instance) {
        ...
        if (!empty($topicfile)) {
            ...
            if (!empty($topic)) {
                ...
                $topictitle = $xpath->query('/dt:topic/title');
                $topictitle = !empty($topictitle->item(0)->nodeValue) ? $topictitle->item(0)->nodeValue : 'Untitled Topic';

                $topictext = $xpath->query('/dt:topic/text');
            ...
            $topicattachments = $xpath->query('/dt:topic/attachments/attachment/@href');
